...
use PrimeMessenger\Primemessenger\Exceptions\InternalServerException;

/**
 * Client provides methods for interacting with the API.
 *
 * @category   Primemessenger
 * @package    Client
 * @copyright  Copyright (c) 2011 {@link http://primemessenger.com Primemessenger, Inc.}
 */
class Client {
